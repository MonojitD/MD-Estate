...
const Header = () => {
  return (
    ...
    <header className='border-0 border-red-700 px-1 py-1 flex flex-wrap justify-between bg-purple-100 sm:px-10'>
        ...
        <ul className="border-0 border-green-700 w-[50%] pl-1 sm:w-[15%] flex justify-between items-center">
            <li><Link to="/" className='text-purple-500 font-[600]  hover:text-purple-800'>Home</Link></li>
            <li><Link to="/about" className='text-purple-500 font-[600]  hover:text-purple-800'>About</Link></li>
